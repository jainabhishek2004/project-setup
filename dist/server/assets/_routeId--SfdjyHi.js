...
import { R as Route, a as api } from "./router-BY3u6Q8c.js";
import { A as AppHeader } from "./AppHeader-DqvummcP.js";
import { R as RouteForm } from "./RouteForm-WAMLXIVD.js";
...
import "jose";
import "lucide-react";
import "./button-Cm5QyDGI.js";
import "@radix-ui/react-slot";
import "class-variance-authority";
import "clsx";
import "tailwind-merge";
import "./label-BKqcuK7M.js";
import "@radix-ui/react-label";
import "./card-rgUlqyCc.js";
function EditRoute() {
  const {
    routeId
  } = Route.useParams();
  ...
  return /* @__PURE__ */ jsxs("div", { className: "mx-auto min-h-screen w-full max-w-3xl space-y-6 p-4", children: [
    ...
    /* @__PURE__ */ jsx(RouteForm, { initial: {
      ...
      start: route.startLat != null && route.startLng != null && route.startExpectedMinutes != null ? {
