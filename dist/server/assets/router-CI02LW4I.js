...
import { createRootRouteWithContext, useRouteContext, Outlet, HeadContent, Scripts, createFileRoute, redirect, lazyRouteComponent } from "@tanstack/react-router";
...
const appCss = "/assets/app-Dby0w3yQ.css";
...
const $$splitComponentImporter$5 = () => import("./sign-up-DXcX_302.js");
...
const $$splitComponentImporter$4 = () => import("./sign-in-DxGe_GBA.js");
...
const $$splitComponentImporter$3 = () => import("./reset-password-CK8bCWYy.js");
const Route$4 = createFileRoute("/reset-password")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./_authed-DlnBRP6y.js");
...
const api = anyApi;
componentsGeneric();
const $$splitComponentImporter$1 = () => import("./index-BGJry6hy.js");
const Route$2 = createFileRoute("/_authed/")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component"),
  loader: async ({
    context
  }) => {
    await Promise.all([context.queryClient.ensureQueryData(convexQuery(api.auth.getCurrentUser, {})), context.queryClient.ensureQueryData(convexQuery(api.todos.get, {}))]);
  }
});
const $$splitComponentImporter = () => import("./settings-CqFsoPR-.js");
const Route$1 = createFileRoute("/_authed/settings")({
...
const AuthedIndexRoute = Route$2.update({
  id: "/",
  path: "/",
  getParentRoute: () => AuthedRoute
});
const AuthedSettingsRoute = Route$1.update({
  id: "/settings",
  path: "/settings",
  getParentRoute: () => AuthedRoute
});
...
Route$7._addFileChildren(rootRouteChildren)._addFileTypes();
function getRouter() {
