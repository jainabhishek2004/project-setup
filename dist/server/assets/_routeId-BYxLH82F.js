...
import { c as Route, a as api } from "./router-4kTeY6y1.js";
import { A as AppHeader } from "./AppHeader-rUzkVB5l.js";
import { e as cn, B as Button, C as Card, b as CardHeader, c as CardTitle, a as CardContent } from "./card-CmruOdWT.js";
...
const RouteMap = lazy(() => import("./RouteMap-DkttuG8I.js").then((m) => ({
  default: m.RouteMap
})));
function MapPage() {
  const {
