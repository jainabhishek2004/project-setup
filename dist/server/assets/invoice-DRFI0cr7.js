...
import { ReceiptText, Upload, FileSpreadsheet, Loader2, Download } from "lucide-react";
import { a as api } from "./router-AUTNzD8t.js";
import { A as AppHeader } from "./AppHeader-DTCaF19G.js";
import { C as Card, a as CardHeader, b as CardTitle, c as CardDescription, d as CardContent, B as Button } from "./card--6FQJDdo.js";
  ...
  return /* @__PURE__ */ jsxs("div", { className: "mx-auto min-h-screen w-full max-w-4xl space-y-6 p-4", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
      ...
      result && /* @__PURE__ */ jsxs(Fragment, { children: [
        ...
        result.hashId && /* @__PURE__ */ jsxs(Button, { variant: "outline", onClick: handleDownloadPdf, disabled: pdfLoading, children: [
          pdfLoading ? /* @__PURE__ */ jsx(Loader2, { size: 16, className: "animate-spin" }) : /* @__PURE__ */ jsx(Download, { size: 16 }),
          "Download PDF"
        ] })
      ] })
    ] }),
