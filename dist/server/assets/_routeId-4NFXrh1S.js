...
import { d as Route, a as api } from "./router-AUTNzD8t.js";
import { A as AppHeader } from "./AppHeader-DTCaF19G.js";
import { e as cn, B as Button, C as Card, a as CardHeader, b as CardTitle, d as CardContent } from "./card--6FQJDdo.js";
      ...
      /* @__PURE__ */ jsxs("div", { className: "-mt-0.5 flex-1 space-y-1", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between gap-2", children: [
          /* @__PURE__ */ jsxs("span", { className: "flex items-center gap-1.5 text-sm font-medium", children: [
            ...
            " ",
            stop.name,
            stop.optional && /* @__PURE__ */ jsx("span", { className: "text-muted-foreground text-[10px] font-normal", children: "(optional)" })
          ] }),
...
const RouteMap = lazy(() => import("./RouteMap-DMHXmLxm.js").then((m) => ({
  default: m.RouteMap
})));
function MapPage() {
  const {
