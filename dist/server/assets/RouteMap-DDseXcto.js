...
import { Plus, Minus, Loader2, Locate, Maximize, X, RefreshCw, Truck } from "lucide-react";
...
function RouteMap({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-3", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "h-[60vh] max-h-[480px] w-full overflow-hidden rounded-lg border", children: /* @__PURE__ */ jsxs(
      Map,
      {
        center,
        zoom: 12,
        ...
        children: [
          ...
          line.length >= 2 && /* @__PURE__ */ jsx(MapRoute, { coordinates: line, color: "#6366f1", dashArray: [2, 2] }),
