...
import { e as cn, B as Button } from "./card--6FQJDdo.js";
...
function RouteMap({
  ...
  const routeKey = useMemo(
    () => `${optimize}|` + plannedCoords.map((c) => `${c.lat.toFixed(6)},${c.lng.toFixed(6)}`).join(";"),
  ...
  useEffect(() => {
    ...
    fn({ coordinates: plannedCoords }).then((r) => {
      if (cancelled) return;
      if (r) setRoute(r);
    ...
    /* @__PURE__ */ jsxs("div", { className: "bg-muted/40 flex flex-wrap items-center gap-x-4 gap-y-1 rounded-md border px-3 py-2 text-xs", children: [
      ...
      routeLoading ? /* @__PURE__ */ jsxs("span", { className: "text-muted-foreground flex items-center gap-1", children: [
        ...
        /* @__PURE__ */ jsxs("span", { children: [
          (route.distanceMeters / 1e3).toFixed(1),
          " km"
        ] }),
        /* @__PURE__ */ jsxs("span", { children: [
          "~",
        ...
        orderedStops.length > 0 && /* @__PURE__ */ jsxs("span", { className: "text-muted-foreground", children: [
          "Order: ",
          orderedStops.map((s) => s.name).join(" → ")
        ] })
      ] }) : /* @__PURE__ */ jsx("span", { className: "text-muted-foreground", children: plannedStops.length < 2 ? "need 2+ planned hubs" : routeError ?? "unavailable" }),
      /* @__PURE__ */ jsxs("span", { className: "ml-auto flex items-center gap-3", children: [
        plannedStops.length >= 2 && /* @__PURE__ */ jsx(
          Button,
          {
            size: "sm",
            variant: "ghost",
            ...
            children: optimize ? "Show regular order" : "Suggest better order"
          }
        ),
        optionalStops.length > 0 && /* @__PURE__ */ jsxs("span", { className: "text-muted-foreground flex items-center gap-1", children: [
          /* @__PURE__ */ jsx("span", { className: "inline-block size-2 rounded-full border border-dashed border-neutral-400" }),
          "optional hub"
        ] })
      ] })
    ] }),
        ...
        children: /* @__PURE__ */ jsxs(
          Map,
          {
            ...
            children: [
              ...
              route && route.geometry.length >= 2 && /* @__PURE__ */ jsx(
                MapRoute,
                {
              ...
              plannedStops.map((stop, i) => /* @__PURE__ */ jsxs(
                MapMarker,
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsx(MarkerContent, { children: /* @__PURE__ */ jsx(
                      "div",
                      {
                        ...
                        children: stop.isStart ? /* @__PURE__ */ jsx(Home, { className: "size-3.5" }) : i + 1
                      }
                    ) }),
                    /* @__PURE__ */ jsx(MarkerLabel, { children: stop.name }),
                    /* @__PURE__ */ jsx(MarkerPopup, { closeButton: true, children: /* @__PURE__ */ jsxs("div", { className: "space-y-1 text-xs", children: [
                      /* @__PURE__ */ jsx("div", { className: "text-sm font-medium", children: stop.name }),
                      /* @__PURE__ */ jsx("div", { className: "text-muted-foreground capitalize", children: stop.status === "captured" ? "visited" : "not visited" }),
              ...
              optionalStops.map((stop) => /* @__PURE__ */ jsxs(
                MapMarker,
                {
                  longitude: stop.targetLng,
                  latitude: stop.targetLat,
                    ...
                    /* @__PURE__ */ jsx(MarkerContent, { children: /* @__PURE__ */ jsx(
                      "div",
                      {
                        className: cn(
                          ...
                          stop.status === "captured" ? "bg-green-500" : "bg-neutral-500/60"
                        )
                      }
                    ) }),
                    /* @__PURE__ */ jsxs(MarkerLabel, { children: [
                      stop.name,
                      " · optional"
                    ] }),
                    /* @__PURE__ */ jsx(MarkerPopup, { closeButton: true, children: /* @__PURE__ */ jsxs("div", { className: "space-y-1 text-xs", children: [
